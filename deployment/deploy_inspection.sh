...
PROJECT_PATH="$TARGET_DIR/src/InspectionService/GEC.InspectionService.csproj"
SERVICE_NAME="inspectionservice.service"
SERVICE_SRC="$TARGET_DIR/deployment/$SERVICE_NAME"
SERVICE_DST="/etc/systemd/system/$SERVICE_NAME"
PUBLISH_DIR="$TARGET_DIR/artifacts/publish/InspectionService"
